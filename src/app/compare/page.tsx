  ...
  return (
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        <h2 className="text-sm font-space-grotesk font-bold text-primary tracking-[0.2em] mb-2 uppercase">Combat Comparison</h2>
        <h1 className="text-4xl md:text-5xl font-space-grotesk font-bold tracking-tight mb-4">VERSUS_MATCH_ENGINE</h1>
        <p className="text-zinc-500 max-w-xl mx-auto">Analyzing playstyles, performance data, and cross-platform achievements to find your perfect competitive match.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-7 gap-6 items-center">
        ...
        <div className="lg:col-span-3 order-1 lg:order-2">
          <GlassCard glow="cyan" className="p-8 text-center bg-primary/5 border-primary/20">
            <div className="flex justify-center mb-8 relative">
                ...
                <div className="w-24 h-24 rounded-full border-4 border-primary/30 flex items-center justify-center bg-black relative z-10">
                    <Swords className="w-12 h-12 text-primary text-glow" />
                </div>
            </div>

            <div className="mb-8">
                <h3 className="text-sm font-bold text-zinc-500 uppercase tracking-widest mb-2">Sync Compatibility</h3>
                <div className="text-5xl font-space-grotesk font-bold text-glow text-primary">{matchScore}%</div>
...
function PlayerVersusCard({ player, color }: any) {
    return (
        <GlassCard glow={color} className="text-center p-8 bg-black/40">
            ...
            <h4 className="font-space-grotesk font-bold text-xl mb-1 truncate">{player.name}</h4>
            <span className={cn(
